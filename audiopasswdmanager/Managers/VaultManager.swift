import Foundation
import SwiftUI
import audiopasswdmanagerCore

/// Bridges audiopasswdmanagerCore with the SwiftUI model layer.
///
/// Vault layout on disk:
/// ```
/// ~/Library/Application Support/audiopasswdmanager/vault/
...
final class VaultManager {
    ...
    private var agent: audiopasswdmanager?

    // MARK: - Paths

    static var vaultDirectory: URL {
        FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("audiopasswdmanager/vault", isDirectory: true)
    }
